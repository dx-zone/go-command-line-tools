...
highlight <filename> -<theme-name-flag>
highlight <filename> --<theme-name>
```
...
highlight errors.log -g  # another option to highlight using the github theme  
highlight errors.log pygments  # highlight using the pygments theme
highlight errors.log --friendly  # yet another option to highlight using the friendly theme
highlight errors.log -t  # highlight using the tango theme
```
